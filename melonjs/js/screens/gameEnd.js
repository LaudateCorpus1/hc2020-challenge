game.GameEndScreen = me.ScreenObject.extend({
     ...
     me.game.world.addChild(new (me.Renderable.extend ({
      ...
      init : function () {
        ...
        this.scrollertween = new me.Tween(this).to({scrollerpos: -2200 }, 20000).onComplete(this.scrollover.bind(this)).start();
      ...
      scrollover : function () {
        ...
        this.scrollerpos = 640;
        this.scrollertween.to({scrollerpos: -2200 }, 20000).onComplete(this.scrollover.bind(this)).start();
